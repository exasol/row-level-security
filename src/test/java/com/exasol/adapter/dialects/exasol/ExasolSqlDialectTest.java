...
class ExasolSqlDialectTest {
    ...
    void testSqlGenerator() throws AdapterException {
        ...
        final String expectedSql =
              "SELECT \"USER_ID\", COUNT(\"URL\") FROM \"" + schemaName + "\".\"CLICKS\"" + " WHERE 1 < \"USER_ID\""
    ...
    private SqlNode getTestSqlNode() {
        ...
        final SqlSelectList selectList = SqlSelectList.createRegularSelectList(
              List.of(new SqlColumn(0, clicksMeta.getColumns().get(0)),
                    new SqlFunctionAggregate(AggregateFunction.COUNT,
        ...
        final SqlOrderBy orderBy =
              new SqlOrderBy(List.of(new SqlColumn(0, clicksMeta.getColumns().get(0))), List.of(true), List.of(true));
    ...
    void testInconsistentExasolProperties() {
        ...
        final AdapterProperties adapterProperties = new AdapterProperties(this.rawProperties);
        final SqlDialect sqlDialect = new ExasolSqlDialect(null, adapterProperties);
        final PropertyValidationException exception =
